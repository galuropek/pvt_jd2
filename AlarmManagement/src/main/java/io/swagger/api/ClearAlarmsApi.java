...
@Api(value = "clearAlarms", description = "the clearAlarms API")
public interface ClearAlarmsApi {

    @ApiOperation(value = "clearAlarmsCreate", nickname = "clearAlarmsCreate", notes = "", response = Alarm.class, tags={ "alarms", })
    @ApiResponses(value = { 
    ...
    ResponseEntity<Alarm> clearAlarmsCreate(@ApiParam(value = "" ,required=true )  @Valid @RequestBody Alarm alarms);
