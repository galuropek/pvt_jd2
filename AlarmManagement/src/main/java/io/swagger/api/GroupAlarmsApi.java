...
@Api(value = "groupAlarms", description = "the groupAlarms API")
public interface GroupAlarmsApi {

    @ApiOperation(value = "groupAlarmsCreate", nickname = "groupAlarmsCreate", notes = "", response = Alarm.class, tags={ "alarms", })
    @ApiResponses(value = { 
        @ApiResponse(code = 201, message = "Alarms", response = Alarm.class) })
    @RequestMapping(value = "/groupAlarms",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)
    ResponseEntity<Alarm> groupAlarmsCreate(@ApiParam(value = "" ,required=true )  @Valid @RequestBody Alarm alarms);
