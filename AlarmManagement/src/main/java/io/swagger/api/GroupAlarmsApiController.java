...
public class GroupAlarmsApiController implements GroupAlarmsApi {
    ...
    private static final Logger log = LoggerFactory.getLogger(GroupAlarmsApiController.class);
    ...
    public ResponseEntity<Alarm> groupAlarmsCreate(@ApiParam(value = "" ,required=true )  @Valid @RequestBody Alarm alarms) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {alarmService.save(alarms);
