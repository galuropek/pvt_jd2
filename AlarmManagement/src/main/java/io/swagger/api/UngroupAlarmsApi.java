...
@Api(value = "ungroupAlarms", description = "the ungroupAlarms API")
public interface UngroupAlarmsApi {

    @ApiOperation(value = "ungroupAlarmsCreate", nickname = "ungroupAlarmsCreate", notes = "", response = Alarm.class, tags={ "alarms", })
    @ApiResponses(value = { 
    ...
    ResponseEntity<Alarm> ungroupAlarmsCreate(@ApiParam(value = "" ,required=true )  @Valid @RequestBody Alarm alarms);
